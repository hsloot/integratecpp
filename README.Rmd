...
This is rather complicated and requires familiarity with pointers.
Additionally, this snippet is missing a translation of the error code into a proper error message To
make it worse, without guarding the callback functions from `C++` exceptions, we introduce possible
undefined behavior.


Using our header simplifies numerical integration in `Rcpp` considerably:
