...
Finally, we implement our function using the `integratecpp` interface to `Rdagi`:
...
double gamma_inc_direct(const double alpha, const double x) {
    ...
    const auto fn_callback = [](double *x, int n, void *ex) {
        ...
        // evaluate `Callable` at *inout* pointer-to-arry `x`
    ...
    // throw `Rcpp::exception` if integration error occured
